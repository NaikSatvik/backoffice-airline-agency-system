                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="manage-emp.php" class=" waves-effect" style="color:white">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3>Manage Employee Account</h3><br>
                                            ...
                                            ?>
                                                <table id="example" class="table table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th data-priority="6">Mobile No</th>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th class="nr1"><span class="co-name"><?php echo $row["fname"]; ?></span></th>
                                                        <td class="nr2"><?php echo $row["lname"]; ?></td>
                                                        <td class="nr3"><?php echo $row["email"]; ?></td>
                                                        <td class="nr4"><?php echo $row["age"]; ?></td>
                                                        <td class="nr5"><?php echo $row["address"]; ?></td>
                                                        <td class="nr6"><?php echo $row["mobile_no"]; ?></td>
                                                        <td class="nr7"><?php echo $row["desig"]; ?></td>
                                                        <td>
                                                            ...
                                                            <form action="config/delete.php" style="display:inline;">
                                                                ...
                                                                <button type="submit" class="btn btn-outline-danger waves-effect waves-light">Remove</button>
                                                            </form>
                                                            </span>
                                                        </td>
                                                    </tr>
